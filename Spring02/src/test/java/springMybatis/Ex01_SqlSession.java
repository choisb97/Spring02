...
public class Ex01_SqlSession {
	...
	public void sqlSessionFactoryTest() {
		...
		assertNotNull(sqlSessionFactory); // Green
...
//-----------------------------------------------------------------------------------------------------
    ...
    // Test 1) 정상의 경우 sqlSessionTest()만 Test
    // Test 2) SqlSessionFactory 생성 안 된 경우 Test
    // Test 3) @Before 적용 sqlSessionFactoryTest(), sqlSessionTest() 모두 Test
	@Test
