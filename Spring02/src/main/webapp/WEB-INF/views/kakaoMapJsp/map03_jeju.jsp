...
<head>
	<meta charset="UTF-8">
	<title>** kakaoMap03_여러 위치 Marking &amp; 설명 **</title>
...
// => zIndex : z-index 속성값 (jQuery의 z-index와 같은 효과)
...
for (var i=0;i<positions.length;i++) {
	...
	var marker = new kakao.maps.Marker({
					...
					// 마커에 마우스를 올리면 타이틀이 표시됨 -> 그러나 html 적용 안 됨
	...
	/* // infoTest 1) 무조건 표시 : 마커에 표시할 인포윈도우 생성   
   	var infowindow = new kakao.maps.InfoWindow({
	    	        content : positions[i].content // 인포윈도우에 표시할 내용 : html 적용 됨
		    	    }); 
...
function makeOverListener(map,marker,infowindow,infoContent) {
	return function() {
		// 이때 infowindow는 상단에 전역으로 정의 해 놓음
